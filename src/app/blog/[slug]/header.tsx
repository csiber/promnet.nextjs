      ...
      <div className='space-y-16 sm:px-8'>
        ...
        <div className='grid grid-cols-2 text-sm max-md:gap-4 md:grid-cols-4'>
          <div className='space-y-1 md:mx-auto'>
            <div className='text-muted-foreground'>Irta</div>
            <a
          ...
          <div className='space-y-1 md:mx-auto'>
            <div className='text-muted-foreground'>Publikálva ekkor</div>
            <div>{formattedDate || '--'}</div>
          </div>
          <div className='space-y-1 md:mx-auto'>
            <div className='text-muted-foreground'>Olvasva</div>
            {viewsIsLoading ? '--' : <div>{viewsData?.views}</div>}
          </div>
          <div className='space-y-1 md:mx-auto'>
            <div className='text-muted-foreground'>Hozzászólva</div>
