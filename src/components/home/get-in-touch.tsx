  ...
  React.useEffect(() => {
    animate(
      [
        ...
        ['#sysadmin', { opacity: 1 }, { duration: 0.3 }],
        [
          '#pointer',
          { left: 50, top: 102 },
          { at: '+0.5', duration: 0.5, ease: 'easeInOut' }
        ],
        ['#sysadmin', { opacity: 0.4 }, { at: '-0.3', duration: 0.1 }],
        ...
        ['#wordpress', { opacity: 1 }, { duration: 0.3 }],
        [
          '#pointer',
          { left: 88, top: 198 },
          { at: '+0.5', duration: 0.5, ease: 'easeInOut' }
        ],
        ['#wordpress', { opacity: 0.4 }, { at: '-0.3', duration: 0.1 }],
        ...
        <div className='flex gap-12 max-md:flex-col'>
          ...
          <div className='relative size-64 max-md:mx-auto' ref={scope}>
            <Image
              ...
              alt='Ülök az asztalom előtt és kódolok'
            />
            <div
              id='next-js'
          ...
          <div className='flex flex-col justify-center px-4'>
            ...
            <p className='text-zinc-300'>
              ...
              <span className='text-muted-foreground'>
                Elérhetö vagyok új projektekhez!
              </span>
            </p>
            <div className='my-8'>
              <a
